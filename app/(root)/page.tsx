...
export default async function Home({searchParams} : {
  ...
  return (
    <>
    <div className="h-[530px] w-full relative overflow-hidden flex flex-col items-center justify-center bg-slate-900 rounded-lg">
      ...
      <p className="sub-heading !max-w-3xl relative">
        Where idea meet like-minded people.
      </p>
